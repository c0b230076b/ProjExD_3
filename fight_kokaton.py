...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.rct.centery = bird.rct.centery  # こうかとんの中心縦座標をビームの中心縦座標に
        self.rct.left = bird.rct.right  # こうかとんの右座標をビームの左座標に
        self.vx, self.vy = +5, 0
...
class Score:
    ...
    def __init__(self,):
        ...
        self.color = (0, 0, 255)
        self.score = 0
        self.img = fonto.render(f"スコア:{self.score}", 0, self.color)
        self.rct = self.img.get_rect()
